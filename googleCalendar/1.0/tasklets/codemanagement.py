...
def main(q, i, params, tags):
    ...
    connection = i.config.clients.mercurial.findByUrl('https://bitbucket.org/incubaid/pylabs_core')
    ...
    recipe.addSource(connection, 'extensions/clients/googleCalendar', q.system.fs.joinPaths(exportdir, 'extensions', 'clients', 'googleCalendar'))
