...
def main(q, i, params, tags):
    ...
    q.system.fs.copyDirTree(q.system.fs.joinPaths(qpackage.getPathFiles(),'generic',  'extensions', 'pylabs_vfsclient'), q.system.fs.joinPaths(q.dirs.baseDir, 'lib', 'pylabs', 'extensions', 'pylabs_vfsclient'))
