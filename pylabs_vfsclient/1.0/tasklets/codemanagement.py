...
def main(q, i, params, tags):
    ...
    connection = i.config.clients.mercurial.findByUrl('https://bitbucket.org/aesalem/pylabs_vfsclient')
    ...
    recipe.addSource(connection, '', q.system.fs.joinPaths(exportdir, 'extensions', 'pylabs_vfsclient'))
