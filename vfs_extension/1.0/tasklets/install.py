...
def main(q, i, params, tags):
    ...
    q.system.fs.copyDirTree(q.system.fs.joinPaths(qpackage.getPathFiles(),'linux64',  'extensions', 'clients', 'VFS_extension'), q.system.fs.joinPaths(q.dirs.baseDir, 'lib', 'pylabs', 'extensions', 'clients', 'VFS_extension'))
    q.extensions.enable('q.cloud.system.vfs')
