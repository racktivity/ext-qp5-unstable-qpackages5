...
def main(q, i, params, tags):
    ...
    connection = i.config.clients.mercurial.findByUrl('https://bitbucket.org/aleieldinsalem/fuse_vfs')
    ...
    recipe.addSource(connection, '', q.system.fs.joinPaths(exportdir, 'extensions', 'fuse_vfs'))
