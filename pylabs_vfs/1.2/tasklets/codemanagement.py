...
def main(q, i, params, tags):
    ...
    connection = i.config.clients.mercurial.findByUrl('https://bitbucket.org/aleieldinsalem/pylabs_vfs')
    ...
    recipe.addSource(connection, '', q.system.fs.joinPaths(exportdir, 'extensions', 'pylabs_vfs'))
