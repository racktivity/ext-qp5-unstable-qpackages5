...
def main(q, i, params, tags):
    ...
    recipe.addSource(connection, '_beta/apps/pylabs_vfs', q.system.fs.joinPaths(exportdir, 'extensions', 'pylabs_vfs'))
    q.system.fs.removeDirTree(q.system.fs.joinPaths(exportdir, 'extensions', 'pylabs_vfs', '_archive'))
    q.system.fs.removeDirTree(q.system.fs.joinPaths(exportdir, 'extensions', 'pylabs_vfs', 'vfsExtension'))
