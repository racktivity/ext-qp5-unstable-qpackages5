...
def main(q, i, params, tags):
    ...
    connection = i.config.clients.mercurial.findByUrl('https://bitbucket.org/syoussef/pylabs_diff/')
    ...
    recipe.addSource(connection, '', q.system.fs.joinPaths(exportdir, 'extensions', 'pylabs_diff'))
